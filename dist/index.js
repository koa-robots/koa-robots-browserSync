...
exports.default = function () {
    ...
    scripts = ['<script type="text/javascript" id="__bs_script__">//<![CDATA[', 'document.write("<script async src=\'http://HOST:3000/browser-sync/browser-sync-client.2.11.0.js\'><\/script>".replace("HOST", location.hostname));', '//]]></script>', '</body>'].join('');
